            ...
            # elif feat.get('type') == 'act_area':
                ...
                if not fish_targets:
                    fish_targets = {
                        ...
                        'drum': False,
                        'grouper': False,
                        'summer-flounder': False,
                        'scup': False,
                        'shark': False,
                        'spot': False,
                        'spotted-sea-trout': False,
                        'striped-bass': False,
                        'tautog': False,
                        'tilefish': False,
                        'tuna': False,
                ...
                new_shape = ActivityPoint(
                    ...
                    f_cobia         = fish_targets['cobia'],
                    f_croaker       = fish_targets['croaker'],
                    f_drum          = fish_targets['drum'],
                    f_grouper       = fish_targets['grouper'],
                    f_summer_flounder = fish_targets['summer-flounder'],
                    f_scup          = fish_targets['scup'],
                    f_shark         = fish_targets['shark'],
                    f_spot          = fish_targets['spot'],
                    f_spotted_sea_trout = fish_targets['spotted-sea-trout'],
                    f_strbass       = fish_targets['striped-bass'],
                    f_tautog        = fish_targets['tautog'],
                    f_tilefish      = fish_targets['tilefish'],
                    f_tuna          = fish_targets['tuna'],
                    f_weakfish      = fish_targets['weakfish'],
                    f_mahi_mahi     = fish_targets['mahi-mahi'],
