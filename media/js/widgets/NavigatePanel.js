...
gwst.widgets.NavigatePanel = Ext.extend(gwst.widgets.WestPanel, {
    ...
    getHtmlText: function() {
        var html_text = '<h2>How to Navigate the Map</h2><p>Use the blue navigation controls on the right to zoom to where you started your last trip in <i><b>'+gwst.settings.month+'</b></i> onboard the following vessel: <i><b>'+gwst.settings.vessel+'</i></b>.</p><h2>Detailed Instructions</h2>';
        return html_text;
    },
