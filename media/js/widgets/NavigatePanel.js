...
gwst.widgets.NavigatePanel = Ext.extend(gwst.widgets.WestPanel, {
    ...
    getHtmlText: function() {
        var html_text = '<h2>Instructions</h2><p>Navigate the map and zoom in to the location you started your last trip.</p>';
        return html_text;
    },
    ...
    onRender: function(){
        ...
        this.button_panel = new gwst.widgets.TwoButtonPanel ({
                btn1_text: 'Skip Drawing',
                btn1_handler: this.skipClicked.createDelegate(this),
                btn1_width: 100,
                btn2_text: 'Continue >>',               
