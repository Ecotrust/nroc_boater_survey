...
gwst.widgets.FishingQuestionsPanel = Ext.extend(gwst.widgets.WestPanel, {
    ...
    onRender: function(){
        ...
        this.fishing_one = new Ext.form.CheckboxGroup({
            ...
            columns: 1,
            items: [
                {boxLabel: 'Billfish (white marlin, blue marlin, sailfish)', name: 'billfish'},
                {boxLabel: 'Black sea bass', name: 'blackseabass'},
                {boxLabel: 'Bluefish', name: 'bluefish'},
                {boxLabel: 'Cobia', name: 'cobia'},
                {boxLabel: 'Croaker', name: 'croaker'},
                {boxLabel: 'Drum (red or black)', name: 'drum'},
                {boxLabel: 'Grouper (any species)', name: 'grouper'},
                {boxLabel: 'Summer flounder (fluke)', name: 'summer-flounder'},
                {boxLabel: 'Scup (porgy)', name: 'scup'},
                {boxLabel: 'Shark (any species)', name: 'shark'},
                {boxLabel: 'Spot', name: 'spot'},
                {boxLabel: 'Spotted sea trout (speckled trout)', name: 'spotted-sea-trout'},
                {boxLabel: 'Striped bass', name: 'striped-bass'},
                {boxLabel: 'Tautog (blackfish)', name: 'tautog'},
                {boxLabel: 'Tilefish (golden or blueline)', name: 'tilefish'},
                {boxLabel: 'Tuna (any species)', name: 'tuna'},
                {boxLabel: 'Weakfish (sea trout)', name: 'weakfish'},
                {boxLabel: 'Mahi mahi (dolphin)', name: 'mahi-mahi'},
