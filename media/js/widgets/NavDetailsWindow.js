...
gwst.widgets.NavDetailsWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function(){	
		...
		Ext.apply(this, {          
            ...
            <ol>\
                <li><b>Move Map</b> - Click on the blue arrow buttons on the top left corner of the map, click & drag with your mouse, or use your keyboard arrows.</li>\
                ...
                <li>For even more detailed information, click the link for the \'detailed instructions\' page at the bottom of the screen.</li>\
            </ol>',
            height:350,
            plain: true,
